...
export default function WeatherCard({
  ...
  return (
    <div
      className="flex flex-col w-[93vw] h-auto text-slate-300 rounded-xl sm:w-fit"
      style={bgImage}
    >
        ...
        <div className="flex flex-col w-fit justify-center items-center glass p-2 m-4 text-white">
          ...
          <div className="flex flex-row h-20 w-fit ">
            <div className="w-16 flex items-end justify-end">
              <p className="text-sm text-blue-300 mr-1 text-shadow">
                {weatherData.main.temp_min}°C
              </p>
            </div>
            <div className="w-20 graph"></div>
            <div className="w-16 flex items-start justify-start">
              <p className="text-sm text-red-300 ml-1 text-shadow">
                {weatherData.main.temp_max}°C
              </p>
            </div>
          </div>
          <p className="text-sm mt-2 text-shadow">
